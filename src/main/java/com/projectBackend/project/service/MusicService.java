...
//계속 Failed: Null object or userResDto in MusicUserDto. 뜨는데 이유를 모르겠습니다.
...
//            return returnDTO;
    ...
    private MusicUserDto convertEntityToUserDto(Music music, String userNickname) {
        ...
        userResDto.setUserEmail(music.getMember().getUserEmail());
        userResDto.setUserPoint(music.getMember().getUserPoint());
